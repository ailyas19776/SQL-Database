...
--SELECT PROJECT1.PUBLIC_USER_INFORMATION.USER_ID, CITIES.CITY_ID FROM PROJECT1.PUBLIC_USER_INFORMATION JOIN CITIES ON PROJECT1.PUBLIC_USER_INFORMATION.CURRENT_CITY = CITIES.CITY_NAME; 
...
SELECT  DISTINCT ALBUM_ID, OWNER_ID, ALBUM_NAME, ALBUM_CREATED_TIME, ALBUM_MODIFIED_TIME, ALBUM_LINK, ALBUM_VISIBILITY, PHOTO_ID  FROM project1.PUBLIC_PHOTO_INFORMATION;
COMMIT;
...
SELECT  DISTINCT EVENT_ID, EVENT_CREATOR_ID, EVENT_NAME, EVENT_TAGLINE, EVENT_DESCRIPTION, EVENT_HOST, EVENT_TYPE, EVENT_SUBTYPE, EVENT_ADDRESS, EVENT_START_TIME, EVENT_END_TIME  FROM project1.PUBLIC_EVENT_INFORMATION WHERE EVENT_ID IS NOT NULL AND EVENT_CITY_ID IS NOT NULL AND EVENT_CREATOR_ID IS NOT NULL;
